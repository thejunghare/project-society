            ...
            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="statistics" role="tabpanel"
                ...
                <dl
                    ...
                    <div class="flex flex-col">
                        <dt class="mb-2 text-3xl font-extrabold">{{ $user_count }}</dt>
                        <dd class="text-gray-500 dark:text-gray-400">Total User</dd>
                    </div>
                    <div class="flex flex-col">
                        <dt class="mb-2 text-3xl font-extrabold">{{ $auditor_count}}</dt>
                        <dd class="text-gray-500 dark:text-gray-400">Total Auditor</dd>
                    </div>
                    <div class="flex flex-col">
                        <dt class="mb-2 text-3xl font-extrabold">{{ $accountant_count }}</dt>
                        <dd class="text-gray-500 dark:text-gray-400">Total accountant</dd>
                    </div>
                    <div class="flex flex-col">
                        <dt class="mb-2 text-3xl font-extrabold">{{ $member_count }}</dt>
                        <dd class="text-gray-500 dark:text-gray-400">Total member</dd>
                    </div>
                </dl>
            </div>
        </div>
