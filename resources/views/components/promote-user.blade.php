...
<div wire:ignore.self id="promote-modal" tabindex="-1" aria-hidden="true"
            class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
            @csrf <!-- Add this line for CSRF token if you are using Laravel -->
            <div class="relative w-full max-w-2xl max-h-full">
                <!-- Modal content -->
                <form wire:submit.prevent="promoteUser" method="POST" action="App\Models\User" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    data-modal-toggle="promote-modal" id="close-button">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="number" name="phone" id="phone" wire:model="phone"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    value="{{$phone}}" required >@error('phone')
                                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                                    role="alert">
                                    <span class="font-medium">{{ $message }}</span>
                                </div>
                            ...
                            {{-- roleName --}}
                            <div class="col-span-6 sm:col-span-3">
                                <label for="roleName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Current Role</label>
                            ...
                            {{-- promoteTo --}}
                            <div class="col-span-6 sm:col-span-3">
                                <label for="promoteTo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Promote to</label>
                                <input type="text" name="promoteTo" id="promoteTo" wire:model="promoteTo"
                                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    required value="{{$promoteTo}}" readonly>
                                    @error('promoteTo')
                                    <div class="p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400"
                                    role="alert">
                                    <span class="font-medium">{{ $message }}</span>
                    ...
                    <div
                        ...
                        <button type="submit" wire:click="promoteUser" wire:loading.attr="disabled" wire:loading.class="hidden"
