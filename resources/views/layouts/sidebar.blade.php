        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href=""
                    ...
                    <span
                        class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">0.3.2</span>
                </a>
            </li>
        </ul>
    </div>
