<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @endif
            {{--  notify socitey memebers for pay bills -> accoutant --}}
            @php
                $accountant = 'accountant';
            @endphp
            @if ($accountant == Auth::user()->role)
                <li>
                    <a href="#"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            @endif
            {{-- see all societies -> auditor --}}
            @php
                $auditor = 'auditor';
            @endphp
            @if ($auditor == Auth::user()->role)
                <li>
                    <a href="/auditor/view/socities"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m4 12 8-8 8 8M6 10.5V19c0 .6.4 1 1 1h3v-3c0-.6.4-1 1-1h2c.6 0 1 .4 1 1v3h3c.6 0 1-.4 1-1v-8.5"/>
            ...
            {{-- see all societies members -> accoutant --}}
            @php
                $accountant = 'accountant';
            @endphp
            @if ($accountant == Auth::user()->role)
            ...
            <li>
                <a href="#"
                    ...
                    <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">0.0.4</span>
                </a>
            </li>
            {{-- Report issues  --}}
            <li>
