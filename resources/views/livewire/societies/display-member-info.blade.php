<div class="mt-16">
    ...
    <div class="p-3 mb-2 mt-2 text-sm text-mygreen-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-mygreen-400" role="alert">
        <span class="font-medium">You are a member of </span> <span class="font-bold "> {{ $member->society->name }}</span>
    </div>
                ...
                <div class="flex flex-wrap gap-4">
                  ...
                  <div class="bg-white dark:border-zinc-800 dark:bg-dark_50 shadow-lg rounded-md border border-zinc-300 flex-1">
                    ...
                    <div class="px-5 py-4 grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700 dark:text-gray-300">
                      <div class="space-y-2">
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Society Name:</strong> {{ $member->society->name }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">President Name:</strong> {{ $member->society->president_name }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Vice President Name:</strong> {{ $member->society->vice_president_name }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Treasurer Name:</strong> {{ $member->society->treasurer_name }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Secretary Name:</strong> {{ $member->society->secretary_name }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Phone Number:</strong> {{ $member->society->phone }}</p>
                      </div>
                      <div class="space-y-2">
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Bank Name:</strong> {{ $member->society->bank_name }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">Account Number:</strong> {{ $member->society->bank_account_number }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">IFSC Code:</strong> {{ $member->society->bank_ifsc_code }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">UPI ID:</strong> {{ $member->society->upi_id }}</p>
                        <p><strong class="font-medium text-gray-800 dark:text-gray-200">UPI Number:</strong> {{ $member->society->upi_number }}</p>
                      </div>
                    </div>
                  </div>
