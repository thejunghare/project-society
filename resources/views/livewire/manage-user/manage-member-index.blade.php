                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            ...
                            <a href="#" type="button" data-modal-target="editUserModal"
                                ...
                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline" wire:click="edit({{ $member->id }})"><svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
